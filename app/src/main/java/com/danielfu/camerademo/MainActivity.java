...
//        popWinChoose.setAnimationStyle(R.style.storeImageChooseStyle);
    ...
    private void openCamera() {
        ...
        if (oriPhotoFile != null) {
            ...
            // content://com.danielfu.camerademo.provider/images/storage/emulated/0/Android/data/com.danielfu.camerademo/files/Pictures/OriPicture/HomePic_20180126_163642902806005.jpg
        ...
        switch (requestCode) {
            ...
            case REQUEST_OPEN_GALLERY:
                if (data != null) {
                    ...
                    //content://com.android.providers.media.documents/document/image%3A126047/storage/emulated/0/tencent/MicroMsg/WeiXin/wx_camera_1516844243127.jpg
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
